...
(function() {
  var BOOK, SEARCHTERM, SLUG, all_books, all_people, all_subjects, all_tags, convert_to_israeli_time, data_callback, date_to_hebrew, do_search, generate_hash, generate_url, iced, initialized, is_good_status, load_data, load_fb_comment_count, loaded_data, onhashchange, pad, process_data, run_templates, search_term, select_item, selected_book, selected_slug, set_title, setup_detailed_links, setup_searchbox, setup_subscription_form, setup_subscriptions, setup_summary, setup_tags, setup_timeline, setup_tooltips, show_watermark, skip_overview, slugify, status_filter, status_to_hebrew, unslugify, update_history, wm_shown, __iced_k,
    __slice = [].slice;
  ...
  setup_timeline = function(item_selector, margins) {
    ...
    return $(item_selector).each(function() {
      ...
      if (conflict) {
        ...
        return buxa_header.before("<div class='stamp conflicting " + stamp_class + "'></div>");
      }
    });
  };
