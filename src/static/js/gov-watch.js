...
(function() {
  var BOOK, CHAPTER, SEARCHTERM, SLUG, all_books, all_chapters, all_subjects, all_tags, data_callback, do_search, generate_hash, generate_url, iced, initialized, load_data, loaded_data, onhashchange, process_data, search_term, select_item, selected_book, selected_chapter, selected_slug, setup_searchbox, show_watermark, skip_overview, update_history, wm_shown, __iced_k,
    __slice = [].slice;
  ...
  data_callback = function(data) {
    var book, chapters, rec, tag, _i, _j, _len, _len2, _ref;
    loaded_data = data;
    all_books = {};
    all_tags = {};
    all_subjects = {};
