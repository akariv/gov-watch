...
(function() {
  var BOOK, SEARCHTERM, SLUG, all_books, all_subjects, all_tags, data_callback, do_search, generate_hash, generate_url, iced, initialized, load_data, loaded_data, onhashchange, process_data, search_term, select_item, selected_book, selected_slug, setup_searchbox, show_watermark, skip_overview, update_history, wm_shown, __iced_k_noop,
    __slice = [].slice;
  ...
  process_data = function() {
    var book, do_list, html, list_template, modal_options, template, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _len,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  do_search = function() {
    var field, found, re, rec, should_show, slug, tag, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _j, _k, _len, _len2, _len3, _ref, _ref2,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
