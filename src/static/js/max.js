...
(function() {
  var BOOK, SEARCHTERM, SLUG, all_books, all_subjects, all_tags, data_callback, do_search, generate_hash, generate_url, iced, initialized, load_data, load_fb_comment_count, loaded_data, onhashchange, process_data, run_templates, search_term, select_item, selected_book, selected_slug, set_title, setup_detailed_links, setup_searchbox, setup_subscription_form, setup_subscriptions, setup_summary, setup_tags, setup_timeline, show_watermark, skip_overview, slugify, status_filter, unslugify, update_history, wm_shown, __iced_k,
    __slice = [].slice;
  ...
  select_item = function(slug) {
    ...
    if (slug) {
      ...
      (function(__iced_k) {
        ...
        return __iced_k(setup_tags(".detail-view .tags > ul > li"));
      });
    } else {
      $("#single-item").html('');
  ...
  load_fb_comment_count = function() {
    $(".commentcount").each(function() {
      var json, slug, ___iced_passed_deferral, __iced_deferrals,
        _this = this;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      slug = $(this).attr('rel');
      (function(__iced_k) {
        ...
        return $(_this).html(json[0].commentsbox_count);
      });
    });
